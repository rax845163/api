...
func (*NamespacedName) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b49e4806d6a8fda9, []int{0}
}
...
func init() {
	proto.RegisterFile("alameda_api/v1alpha1/datahub/metadata.proto", fileDescriptor_metadata_b49e4806d6a8fda9)
}

var fileDescriptor_metadata_b49e4806d6a8fda9 = []byte{
