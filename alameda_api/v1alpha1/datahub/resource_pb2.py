...
_RESOURCEINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='owner_namespaced_name', full_name='containers_ai.alameda.v1alpha1.datahub.ResourceInfo.owner_namespaced_name', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='owner_kind', full_name='containers_ai.alameda.v1alpha1.datahub.ResourceInfo.owner_kind', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RESOURCEINFO.fields_by_name['owner_namespaced_name'].message_type = alameda__api_dot_v1alpha1_dot_datahub_dot_metadata__pb2._NAMESPACEDNAME
_RESOURCEINFO.fields_by_name['owner_kind'].enum_type = _KIND
