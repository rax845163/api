...
func (Kind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_resource_d8b740eb0615ebd2, []int{0}
}
...
func (*Pod) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_d8b740eb0615ebd2, []int{1}
}
...
func (*Capacity) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_d8b740eb0615ebd2, []int{2}
}
...
func (*Node) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_d8b740eb0615ebd2, []int{3}
}
...
func (*TopController) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_d8b740eb0615ebd2, []int{4}
}
...
type ResourceInfo struct {
	OwnerNamespacedName  *NamespacedName `protobuf:"bytes,1,opt,name=owner_namespaced_name,json=ownerNamespacedName,proto3" json:"owner_namespaced_name,omitempty"`
	OwnerKind            Kind            `protobuf:"varint,2,opt,name=owner_kind,json=ownerKind,proto3,enum=containers_ai.alameda.v1alpha1.datahub.Kind" json:"owner_kind,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (*ResourceInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_d8b740eb0615ebd2, []int{5}
}
...
func (m *ResourceInfo) GetOwnerNamespacedName() *NamespacedName {
	if m != nil {
		return m.OwnerNamespacedName
	}
	return nil
}

func (m *ResourceInfo) GetOwnerKind() Kind {
	if m != nil {
		return m.OwnerKind
	}
	return Kind_POD
...
func (*Controller) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_d8b740eb0615ebd2, []int{6}
}
...
func init() {
	proto.RegisterFile("alameda_api/v1alpha1/datahub/resource.proto", fileDescriptor_resource_d8b740eb0615ebd2)
}

var fileDescriptor_resource_d8b740eb0615ebd2 = []byte{
	// 837 bytes of a gzipped FileDescriptorProto
	,
}
