...
_TIMESERIESDATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='time', full_name='TimeSeriesData.time', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='TimeSeriesData.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PREDICTCONTAINER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rowPredictData', full_name='PredictContainer.rowPredictData', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='initialResource', full_name='PredictContainer.initialResource', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PREDICTPOD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='predictContainers', full_name='PredictPod.predictContainers', index=3,
...
_POSTPREDICTRESULTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='predictPods', full_name='PostPredictResultRequest.predictPods', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TIMESERIESDATA.fields_by_name['time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
...
_PREDICTCONTAINER.fields_by_name['rowPredictData'].message_type = _PREDICTCONTAINER_ROWPREDICTDATAENTRY
_PREDICTCONTAINER.fields_by_name['recommendations'].message_type = _RECOMMENDATION
_PREDICTCONTAINER.fields_by_name['initialResource'].message_type = _RESOURCE
_PREDICTPOD.fields_by_name['predictContainers'].message_type = _PREDICTCONTAINER
_POSTPREDICTRESULTREQUEST.fields_by_name['predictPods'].message_type = _PREDICTPOD
