...
from ai_service import alameda_pb2 as ai__service_dot_alameda__pb2
...
class AlamendaAIServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.CreatePredictionObjects = channel.unary_unary(
        ...
        request_serializer=ai__service_dot_alameda__pb2.PredictionObjectListCreationRequest.SerializeToString,
        response_deserializer=ai__service_dot_alameda__pb2.RequestResponse.FromString,
        )
    self.DeletePredictionObjects = channel.unary_unary(
        '/AlamendaAIService/DeletePredictionObjects',
        request_serializer=ai__service_dot_alameda__pb2.PredictionObjectListDeletionRequest.SerializeToString,
...
def add_AlamendaAIServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'CreatePredictionObjects': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=ai__service_dot_alameda__pb2.PredictionObjectListCreationRequest.FromString,
          response_serializer=ai__service_dot_alameda__pb2.RequestResponse.SerializeToString,
      ),
      'DeletePredictionObjects': grpc.unary_unary_rpc_method_handler(
          servicer.DeletePredictionObjects,
          request_deserializer=ai__service_dot_alameda__pb2.PredictionObjectListDeletionRequest.FromString,
