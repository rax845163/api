...
type Limit struct {
	ResourceLimits       map[string]string `protobuf:"bytes,1,rep,name=resource_limits,json=resourceLimits,proto3" json:"resource_limits,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *Limit) GetResourceLimits() map[string]string {
	if m != nil {
...
type Request struct {
	ResourceRequests     map[string]string `protobuf:"bytes,1,rep,name=resource_requests,json=resourceRequests,proto3" json:"resource_requests,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *Request) GetResourceRequests() map[string]string {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "Limit.ResourceLimitsEntry")
	proto.RegisterType((*Request)(nil), "Request")
	proto.RegisterMapType((map[string]string)(nil), "Request.ResourceRequestsEntry")
...
var fileDescriptor_2191342ef815e384 = []byte{
	...
	,
}
